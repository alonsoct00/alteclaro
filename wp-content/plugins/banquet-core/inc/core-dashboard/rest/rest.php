...
if ( ! class_exists( 'BanquetCoreDashboardRestAPI' ) ) {
	 ...
	 */
	class BanquetCoreDashboardRestAPI {
		...
		public function __construct() {
			// Init variables
			$this->set_namespace( 'banquet-core/v1' );
			$this->set_route( 'dashboard' );
			
			// Localize theme's main js script with rest variable
			add_filter( 'banquet_core_dashboard_filter_js_global_variables', array( $this, 'localize_script' ) );
	...
	BanquetCoreDashboardRestAPI::get_instance();
}
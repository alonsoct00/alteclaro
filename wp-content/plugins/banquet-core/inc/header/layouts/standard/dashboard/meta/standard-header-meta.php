...
if ( ! function_exists( 'banquet_core_add_standard_header_meta' ) ) {
	function banquet_core_add_standard_header_meta( $page ) {
	...
	add_action( 'banquet_core_action_after_page_header_meta_map', 'banquet_core_add_standard_header_meta' );
}
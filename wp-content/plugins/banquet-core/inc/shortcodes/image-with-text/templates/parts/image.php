<div class="qodef-m-image">
	...
	<?php } ?>
		...
		<img class="qodef-e-frame" src="<?php echo BANQUET_CORE_SHORTCODES_URL_PATH ?>/image-with-text/assets/img/scrolling-image-frame.png" alt="<?php esc_html_e('Scrolling Image Frame', 'banquet-core') ?>" />
	</div>
<?php } ?>
</div>
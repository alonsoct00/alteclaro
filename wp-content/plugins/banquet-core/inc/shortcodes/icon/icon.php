...
if ( ! function_exists( 'banquet_core_add_icon_shortcode' ) ) {
	/**
	 ...
	 * @return array
	 */
	function banquet_core_add_icon_shortcode( $shortcodes ) {
		$shortcodes[] = 'BanquetCoreIconShortcode';
		
		return $shortcodes;
	}
	
	add_filter( 'banquet_core_filter_register_shortcodes', 'banquet_core_add_icon_shortcode', 8 );
}

if ( class_exists( 'BanquetCoreShortcode' ) ) {
	class BanquetCoreIconShortcode extends BanquetCoreShortcode {
		
		public function map_shortcode() {
			$this->set_shortcode_path( BANQUET_CORE_SHORTCODES_URL_PATH . '/icon' );
			$this->set_base( 'banquet_core_icon' );
			$this->set_name( esc_html__( 'Icon', 'banquet-core' ) );
			$this->set_description( esc_html__( 'Shortcode that adds icon element', 'banquet-core' ) );
			...
			$this->set_option( array(
				'field_type'	=> 'iconpack',
				'name'			=> 'main_icon',
				'title'			=> esc_html__( 'Icon', 'banquet-core' ),
			) );
			$this->set_option( array(
				'field_type' => 'select',
				'name'       => 'size',
				...
				'options'    => array(
					...
					'tiny'    => esc_html__( 'Tiny', 'banquet-core' ),
					'small'   => esc_html__( 'Small', 'banquet-core' ),
					'medium'  => esc_html__( 'Medium', 'banquet-core' ),
					'large'   => esc_html__( 'Large', 'banquet-core' ),
					'huge'    => esc_html__( 'Huge', 'banquet-core' ),
				)
			) );
			$this->set_option( array(
				'field_type' => 'text',
				'name'       => 'custom_size',
				'title'      => esc_html__( 'Custom Size', 'banquet-core' ),
			) );
			$this->set_option( array(
				'field_type'    => 'select',
				'name'          => 'icon_layout',
				...
				'options'       => array(
					'normal' => esc_html__( 'Normal', 'banquet-core' ),
					'circle' => esc_html__( 'Circle', 'banquet-core' ),
					'square' => esc_html__( 'Square', 'banquet-core' )
				),
			...
			$this->set_option( array(
				'field_type' => 'text',
				'name'       => 'border_radius',
				'title'      => esc_html__( 'Border Radius', 'banquet-core' ),
				'dependency' => array(
					'show' => array(
						'icon_layout' => array(
							'values'        => 'square',
			...
			$this->set_option( array(
				'field_type' => 'text',
				'name'       => 'shape_size',
				'title'      => esc_html__( 'Shape Size', 'banquet-core' ),
				'dependency' => array(
					'show' => array(
						'icon_layout' => array(
			...
			$this->set_option( array(
				'field_type' => 'text',
				'name'       => 'border_width',
				'title'      => esc_html__( 'Border Width', 'banquet-core' ),
				'dependency' => array(
					'show' => array(
						'icon_layout' => array(
							'values'        => array( 'circle', 'square' ),
			...
			$this->set_option( array(
				'field_type' => 'text',
				'name'       => 'link',
				'title'      => esc_html__( 'Icon Link', 'banquet-core' )
			) );
			$this->set_option( array(
				'field_type'    => 'select',
				'name'          => 'target',
		...
		public static function call_shortcode( $params ) {
			$html = qode_framework_call_shortcode( 'banquet_core_icon', $params );
			$html = str_replace( "\n", '', $html );
		...
		public function render( $options, $content = null ) {
			...
			return banquet_core_get_template_part( 'shortcodes/icon', 'templates/icon', '', $atts );
		}

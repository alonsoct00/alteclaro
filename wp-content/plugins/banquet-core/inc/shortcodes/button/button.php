...
if ( ! function_exists( 'banquet_core_add_button_shortcode' ) ) {
	/**
	 ...
	 * @return array
	 */
	function banquet_core_add_button_shortcode( $shortcodes ) {
		$shortcodes[] = 'BanquetCoreButtonShortcode';
		
		return $shortcodes;
	}
	
	add_filter( 'banquet_core_filter_register_shortcodes', 'banquet_core_add_button_shortcode', 9 );
}

if ( class_exists( 'BanquetCoreShortcode' ) ) {
	class BanquetCoreButtonShortcode extends BanquetCoreShortcode {
		
		public function __construct() {
			$this->set_layouts( apply_filters( 'banquet_core_filter_button_layouts', array() ) );
			
			parent::__construct();
		}
		
		public function map_shortcode() {
			$this->set_shortcode_path( BANQUET_CORE_SHORTCODES_URL_PATH . '/button' );
			$this->set_base( 'banquet_core_button' );
			$this->set_name( esc_html__( 'Button', 'banquet-core' ) );
			$this->set_description( esc_html__( 'Shortcode that displays button with provided parameters', 'banquet-core' ) );
			...
			$this->set_option( array(
				'field_type' => 'select',
				'name'       => 'size',
				'title'      => esc_html__( 'Size', 'banquet-core' ),
				'options'    => array(
					''      => esc_html__( 'Normal', 'banquet-core' ),
					'small' => esc_html__( 'Small', 'banquet-core' ),
					'large' => esc_html__( 'Large', 'banquet-core' )
				)
			) );
			$this->set_option( array(
				'field_type' => 'text',
			...
			$this->set_option( array(
				'field_type' => 'text',
				'name'       => 'link',
				'title'      => esc_html__( 'Button Link', 'banquet-core' )
			) );
			$this->set_option( array(
				'field_type'    => 'select',
				'name'          => 'target',
				'title'         => esc_html__( 'Target', 'banquet-core' ),
			...
			$this->set_option( array(
				...
				'group'      => esc_html__( 'Style', 'banquet-core' )
			) );
			$this->set_option( array(
				'name'       => 'hover_color',
				'field_type' => 'color',
				'title'      => esc_html__( 'Text Hover Color', 'banquet-core' ),
				'group'      => esc_html__( 'Style', 'banquet-core' )
			) );
			$this->set_option( array(
				'field_type' => 'color',
			...
			$this->set_option( array(
				...
				'title'      => esc_html__( 'Background Hover Color', 'banquet-core' ),
				'group'      => esc_html__( 'Style', 'banquet-core' )
			) );
			$this->set_option( array(
				'field_type' => 'color',
				'name'       => 'border_color',
				'title'      => esc_html__( 'Border Color', 'banquet-core' ),
				'group'      => esc_html__( 'Style', 'banquet-core' )
			) );
			$this->set_option( array(
				'field_type' => 'color',
				'name'       => 'hover_border_color',
				'title'      => esc_html__( 'Border Hover Color', 'banquet-core' ),
				'group'      => esc_html__( 'Style', 'banquet-core' )
			) );
			$this->set_option( array(
				'field_type' => 'text',
				'name'       => 'margin',
				'title'      => esc_html__( 'Margin', 'banquet-core' ),
				'group'      => esc_html__( 'Style', 'banquet-core' )
			) );
			$this->set_option( array(
				'field_type' => 'text',
				'name'       => 'padding',
				'title'      => esc_html__( 'Padding', 'banquet-core' ),
				'group'      => esc_html__( 'Style', 'banquet-core' )
			) );
			$this->set_option( array(
				'field_type' => 'text',
				...
				'group'      => esc_html__( 'Typography', 'banquet-core' )
			) );
			$this->set_option( array(
				'field_type' => 'select',
				'name'       => 'font_weight',
			...
			$this->set_option( array(
				'field_type'    => 'select',
				'name'          => 'html_type',
				'title'         => esc_html__( 'HTML Type', 'banquet-core' ),
				'options'       => array(
					'default' => esc_html__( 'Default', 'banquet-core' ),
					'input'   => esc_html__( 'Input', 'banquet-core' ),
					'submit'  => esc_html__( 'Submit', 'banquet-core' )
				),
			...
			$this->set_option( array(
				'field_type' => 'text',
				'name'       => 'input_name',
				'title'      => esc_html__( 'Input Name', 'banquet-core' ),
				'visibility'    => array(
					'map_for_page_builder'    => false
				)
			) );
			$this->set_option( array(
				'field_type' => 'array',
				'name'       => 'custom_attrs',
				'title'      => esc_html__( 'Custom Data Attributes', 'banquet-core' ),
				'visibility'    => array(
					'map_for_page_builder'    => false
				)
			) );
		...
		public static function call_shortcode( $params ) {
			$html = qode_framework_call_shortcode( 'banquet_core_button', $params );
			$html = str_replace( "\n", '', $html );
		...
		public function render( $options, $content = null ) {
			...
			return banquet_core_get_template_part( 'shortcodes/button', 'variations/'.$atts['button_layout'].'/templates/' . $atts['html_type'], '', $atts );
		}

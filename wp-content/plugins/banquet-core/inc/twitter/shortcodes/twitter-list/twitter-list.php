...
if ( ! function_exists( 'banquet_core_add_twitter_list_shortcode' ) ) {
	/**
	 ...
	 * @return array
	 */
	function banquet_core_add_twitter_list_shortcode( $shortcodes ) {
		if( qode_framework_is_installed( 'twitter' ) ) {
			$shortcodes[] = 'BanquetCoreTwitterListShortcode';
		}
		
		return $shortcodes;
	}
	
	add_filter( 'banquet_core_filter_register_shortcodes', 'banquet_core_add_twitter_list_shortcode' );
}

if ( class_exists( 'BanquetCoreListShortcode' ) ) {
	class BanquetCoreTwitterListShortcode extends BanquetCoreListShortcode {
		
		public function map_shortcode() {
			$this->set_shortcode_path( BANQUET_CORE_INC_URL_PATH . '/twitter/shortcodes/twitter-list' );
			$this->set_base( 'banquet_core_twitter_list' );
			$this->set_name( esc_html__( 'Twitter List', 'banquet-core' ) );
			$this->set_description( esc_html__( 'Shortcode that displays twitter list', 'banquet-core' ) );
			...
			$this->set_option( array(
				...
				'field_type' => 'text',
				'title'      => esc_html__( 'Number of Tweets', 'banquet-core' ),
				'group'      => esc_html__( 'Info', 'banquet-core' )
			) );
			$this->set_option( array(
				'name'          => 'show_retweeted_text',
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Retweeted Text', 'banquet-core' ),
			...
			$this->set_option( array(
				...
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Avatar Image', 'banquet-core' ),
				'options'       => banquet_core_get_select_type_options_pool( 'yes_no' ),
				'default_value' => 'yes',
				'group'         => esc_html__( 'Info', 'banquet-core' )
			) );
			$this->set_option( array(
				...
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Author Name', 'banquet-core' ),
				'options'       => banquet_core_get_select_type_options_pool( 'yes_no' ),
				'default_value' => 'yes',
				'group'         => esc_html__( 'Info', 'banquet-core' )
			) );
			$this->set_option( array(
				...
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Tweet Text', 'banquet-core' ),
				'options'       => banquet_core_get_select_type_options_pool( 'yes_no' ),
				'default_value' => 'yes',
				'group'         => esc_html__( 'Info', 'banquet-core' )
			) );
			$this->set_option( array(
				...
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Media Placeholder', 'banquet-core' ),
			...
			$this->set_option( array(
				'name'          => 'show_date',
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Date', 'banquet-core' ),
				'options'       => banquet_core_get_select_type_options_pool( 'yes_no' ),
				'default_value' => 'yes',
				'group'         => esc_html__( 'Info', 'banquet-core' )
			) );
			$this->set_option( array(
				...
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Tweet Actions', 'banquet-core' ),
				'options'       => banquet_core_get_select_type_options_pool( 'yes_no' ),
				'default_value' => 'yes',
				'group'         => esc_html__( 'Info', 'banquet-core' )
			) );
			$this->set_option( array(
				...
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Twitter Link', 'banquet-core' ),
				'options'       => banquet_core_get_select_type_options_pool( 'no_yes' ),
				'default_value' => 'no',
				'group'         => esc_html__( 'Info', 'banquet-core' )
			) );
		...
		public function render( $options, $content = null ) {
			...
			return banquet_core_get_template_part( 'twitter/shortcodes/twitter-list', 'templates/twitter-list', '', $atts );
		}

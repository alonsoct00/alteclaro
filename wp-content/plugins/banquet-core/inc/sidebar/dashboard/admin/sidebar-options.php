...
if ( ! function_exists( 'banquet_core_add_page_sidebar_options' ) ) {
	/**
	 * Function that add general options for this module
	 */
	function banquet_core_add_page_sidebar_options() {
		...
		$page = $qode_framework->add_options_page(
			array(
				...
				'slug'        => 'sidebar',
				'icon'        => 'fa fa-book',
				'title'       => esc_html__( 'Sidebar', 'banquet-core' ),
				'description' => esc_html__( 'Global settings related to page sidebar', 'banquet-core' )
			)
		);
		...
		if ( $page ) {
			...
			do_action( 'banquet_core_action_after_page_sidebar_options_map', $page );
		}
	}
	
	add_action( 'banquet_core_action_default_options_init', 'banquet_core_add_page_sidebar_options', banquet_core_get_admin_options_map_position( 'sidebar' ) );
}
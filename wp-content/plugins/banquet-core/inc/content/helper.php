...
if ( ! function_exists( 'banquet_core_set_page_content_styles' ) ) {
	/**
	 ...
	 * @return string
	 */
	function banquet_core_set_page_content_styles( $style ) {
		$styles = array();
		
		$content_margin = apply_filters( 'banquet_core_filter_content_margin', 0 );
		...
		$style_mobile = array();
		$content_margin_mobile = apply_filters( 'banquet_core_filter_content_margin_mobile', 0 );
	...
	add_filter( 'banquet_filter_add_inline_style', 'banquet_core_set_page_content_styles' );
}
...
if ( ! function_exists( 'banquet_core_fullscreen_menu_options' ) ) {
	function banquet_core_fullscreen_menu_options() {
		...
		$page = $qode_framework->add_options_page(
			array(
				...
				'icon'        => 'fa fa-cog',
				'title'       => esc_html__( 'Fullscreen Menu', 'banquet-core' ),
				'description' => esc_html__( 'Fullscreen Menu Settings', 'banquet-core' )
			)
		);
		...
		if ( $page ) {
			$page->add_field_element(
				array(
					...
					'title'         => esc_html__( 'Fullscreen Menu in Grid', 'banquet-core' ),
					'default_value' => 'yes'
				)
			);
			...
			do_action( 'banquet_core_action_after_fullscreen_menu_options_map', $page );
		}
	}
	
	add_action( 'banquet_core_action_default_options_init', 'banquet_core_fullscreen_menu_options', banquet_core_get_admin_options_map_position( 'fullscreen-menu' ) );
}
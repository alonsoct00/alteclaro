...
if ( ! function_exists( 'banquet_core_add_simple_line_icons_to_collection' ) ) {
	function banquet_core_add_simple_line_icons_to_collection( $icons ) {
		$icons[] = 'BanquetCoreSimpleLineIconsPack';
		return $icons;
	}
	
	add_filter( 'qode_framework_filter_add_icon', 'banquet_core_add_simple_line_icons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class BanquetCoreSimpleLineIconsPack extends QodeFrameworkIconPack {
		...
		public function get_style_url() {
			return BANQUET_CORE_INC_URL_PATH . '/icons/' . $this->get_base() . '/assets/css/' . $this->get_base() . '.min.css';
		}

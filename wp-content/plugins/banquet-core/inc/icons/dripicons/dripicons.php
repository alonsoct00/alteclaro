...
if ( ! function_exists( 'banquet_core_add_dripicons_to_collection' ) ) {
	function banquet_core_add_dripicon_to_collection( $icons ) {
		$icons[] = 'BanquetCoreDripiconsIconPack';
		return $icons;
	}
	
	add_filter( 'qode_framework_filter_add_icon', 'banquet_core_add_dripicon_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class BanquetCoreDripiconsIconPack extends QodeFrameworkIconPack {

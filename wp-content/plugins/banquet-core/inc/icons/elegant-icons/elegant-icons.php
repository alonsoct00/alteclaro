...
if ( ! function_exists( 'banquet_core_add_elegant_icons_to_collection' ) ) {
	function banquet_core_add_elegant_icons_to_collection( $icons ) {
		$icons[] = 'BanquetCoreElegantIconsPack';
		return $icons;
	}
	
	add_filter( 'qode_framework_filter_add_icon', 'banquet_core_add_elegant_icons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class BanquetCoreElegantIconsPack extends QodeFrameworkIconPack {

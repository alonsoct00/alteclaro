	...
	<div class="qodef-m-pagination qodef--load-more" <?php qode_framework_inline_style($pagination_type_load_more_top_margin); ?>>
		<div class="qodef-m-pagination-inner">
			...
			$button_params = array(
				...
				'link'          => '#',
				'text'          => esc_html__( 'Load More', 'banquet' )
			);
			
			banquet_render_button_element( $button_params ); ?>
		</div>
	</div>
	<?php
	// Include loading spinner
	banquet_render_icon( 'qodef-loading-spinner fa fa-spinner fa-spin', 'font-awesome', '' ); ?>
<?php } ?>